export default function UniversityCard({ uni }) {
  return (
    <div className="bg-white rounded-lg shadow-md hover:shadow-lg transition-all overflow-hidden flex flex-col h-full min-h-[380px]">
      <img
        src={`https://source.unsplash.com/400x250/?university,${uni.pais}`} // Cambié la altura de la imagen
        alt="uni"
        className="h-48 w-full object-cover" // Cambié de h-40 a h-48
      />
      <div className="p-3 flex flex-col justify-between flex-1"> {/* Cambié de p-4 a p-3 */}
        <div>
