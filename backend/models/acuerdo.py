...
def crear_acuerdo(data, version=1):
    return {
        ...
        "bloques": [
            {
                "tipo": b.get("tipo", "1x1"),
                "optatividad": b.get("optatividad", False),
                "observaciones": b.get("observaciones", ""),
                "comentario_tutor": b.get("comentario_tutor", ""),
                "asignaturas_ugr": b.get("asignaturas_ugr", []),
                "asignaturas_destino": b.get("asignaturas_destino", [])
            }
